...
export class TenantConfigurationComponent implements OnInit {
    ...
    getHelperText(key): string {
        switch (key) {
            ...
            case ETenantConfig.AUTH_CLIENT_ID:
                return 'This is the auth client ID which you will get from the application once you onboard. Navigate to the Authentication section in the left navigation bar and click on Registration profiles, you will be able to see verify profile copy the value of the profile id.';
            default:
                return '';
        }
    }
